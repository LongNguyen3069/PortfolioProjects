...
Source: Hotel booking Excel dataset by Mojtaba on Kaggle.com Format: Imported into SQL Server Management Studio from Excel
...
Raw Table (immutable) ↓ Cleaned View (standardized) ↓ Analytics View (business metrics & KPIs)
...
🔹 Raw Table dbo.hotel_bookings_raw
...
🔹 Cleaned Analytics View dbo.vw_hotel_bookings_clean
...
🔹 Final Analytics View dbo.vw_hotel_analytics
...
Long Nguyen Aspiring Data Analyst | SQL | Data Cleaning | Analytics Engineering
